...
WHERE
{
    ...
    # ?item wdt:P279 wd:Q24060765 . # animal organ (Q24060765), 34 resuldados em 2020 (ainda pouco)
    ?item wdt:P7173 ?item_id # Filter by require Terminologia Anatomica, 2019 Edition ID (9603 results in 2020) 
